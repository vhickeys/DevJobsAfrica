    ...
    <footer class="main-footer -type-13 alternate3">
                        ...
                        <div class="row">
                            <div class="footer-column col-lg-3 col-md-6 col-sm-12">
                                <div class="footer-widget links-widget">
                                    <h4 class="widget-title">For Consultants</h4>
                                    <div class="widget-content">
                                        <ul class="list">
                                            <li><a href="#">Browse Consultants</a></li>
                                            <li><a href="#">Consultant Dashboard</a></li>
                                ...
                                <div class="footer-widget links-widget">
                                    ...
                                    <div class="widget-content">
                                        <ul class="list">
                                            ...
                                            <li><a href="#">Job Seekers Dashboard</a></li>
                                            <li><a href="#">Job Packages</a></li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <div class="footer-bottom">
            <div class="auto-container">
                <div class="outer-box">
                    <div class="copyright-text">© <?= date('Y') ?> <a href="#">DevJobs Africa</a>. All Right Reserved.</div>

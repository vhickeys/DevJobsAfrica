            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <span class="nav-text">Job Listing</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="create-job.php">Create a new Job Listing</a></li>
                            <li><a href="view-jobs.php">View All Job Listings</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="create-sector.php">Create Sector</a></li>
                            <li><a href="view-sectors.php">View All Sectors</a></li>
                        </ul>
                    </li>

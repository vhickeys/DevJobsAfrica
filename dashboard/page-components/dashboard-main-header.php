        ...
        <div class="nav-outer">
            <div class="logo-box">
                <div class="logo"><a href="index.php">
                        <h3 class="fw-bold text-dark">Dev Jobs Africa</h3>
                    </a></div>
            </div>
        ...
        <div class="outer-box">
            ...
            <div class="dropdown dashboard-option">
                ...
                <ul class="dropdown-menu">
                    <li class="<?= setActivePage($current_page, 'index.php'); ?>"><a href="index.php"> <i
                                class="la la-home"></i> Dashboard</a></li>
                    <?php if (($_SESSION['user_data']['role'] == 'consultant') || ($_SESSION['user_data']['role'] == 'jobSeeker')): ?>

                        <li class="<?= setActivePage($current_page, 'my-profile.php'); ?>"><a href="my-profile.php"><i
                                    class="la la-user-tie"></i>My Profile</a></li>
                        <li class="<?= setActivePage($current_page, 'my-resume.php'); ?>"><a href="my-resume.php"><i
                                    class="la la-file-invoice"></i>My Resume</a></li>
                        <li class="<?= setActivePage($current_page, 'applied-jobs.php'); ?>"><a href="applied-jobs.php"><i
                                    class="la la-briefcase"></i> Applied Jobs </a></li>
                        <li class="<?= setActivePage($current_page, 'job-alerts.php'); ?>"><a href="job-alerts.php"><i
                                    class="la la-bell"></i>Job Alerts</a></li>
                        <li class="<?= setActivePage($current_page, ''); ?>"><a href="javascript:void(0)"><i
                                    class="la la-bookmark-o"></i>Shortlisted Jobs</a></li>
                        <li class="<?= setActivePage($current_page, ''); ?>"><a href="javascript:void(0)"><i
                                    class="la la-file-invoice"></i> CV manager</a></li>
                        <li class="<?= setActivePage($current_page, ''); ?>"><a href="javascript:void(0)"><i

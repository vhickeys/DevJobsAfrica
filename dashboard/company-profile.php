...
authRoleCheckJobUser('jobSeeker', '../login', 'index', 'You are not authorized to access this page. Not a Job Seeker!');
authRoleCheckJobUser('consultant', '../login', 'index', 'You are not authorized to access this page. Not a Consultant!');

$page_title = 'Company Profile';
$current_page = 'company-profile.php';
